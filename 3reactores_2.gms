...
*restr1.. (sum(i, q(i)) - qmax) =E= 0;
*restr2.. (sum(i, qc(i)) - qcmax) =E= 0;
CostoTotal.. J_total =E= J1 + J2 + J3 - mu1*(sum(i, q(i)) - qmax) - mu2*(sum(i, qc(i)) - qcmax);
...
solve completo minimizing J_total using NLP;

Display q.l, qc.l, T.l, Tc.l, Ca.l, Cb.l, J_total.l, mu1.l, mu2.l;
