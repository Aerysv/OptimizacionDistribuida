...
Restricciones de recursos compartidos: Flujo de reactivos y refrigerante
$offtext
...
TotalReactivos.. sum(i, q(i)) =E= qmax;

TotalRefrigerante.. sum(i, qc(i)) =E= qcmax;
...
Display q.l, qc.l, T.l, Tc.l, Ca.l, Cb.l, J.l;
