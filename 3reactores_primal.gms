...
Parameters
    ...
    alpha(i)   "Parámetros de transmisión de calor (kJ/ºC)"
                /1 1,
                 2 1.22,
                 3 1.42/
    s(i)    "Parámetros de asignación de reactivos"
            /1 1.7,
            2 3,
            3 0.3/
    sc(i)  "Parámetros de asignación de refrigerante"
            /1 14,
            2 25,
            3 1/;
...
Positive Variables
    ...
    qc(i)   "Caudal de refrigerante (L/min)"
            /1.l 14,
             2.l 25,
             3.l 1/
    lambda(i)   "Multiplicador asociado a la restriccion de reactivos"
            /1.l 0,
             2.l 0,
             3.l 0/
    lambdac(i) "Multiplicador asociado a la restriccion de refrigerante"
            /1.l 0,
             2.l 0,
             3.l 0/;
Variables
...
Equations
    ...
    CostoTotal          "Costo del problema global";
...
CostoIndividual1..  J1 =E= -(q('1')*(c_b*Cb('1') + c_c*Cc('1') + c_d*Cd('1') - c_a*Ca('1')) - c_qc*qc('1')) + lambda('1')*(q('1') - s('1')) + lambdac('1')*(qc('1') - sc('1'));
...
CostoIndividual2..  J2 =E= -(q('2')*(c_b*Cb('2') + c_c*Cc('2') + c_d*Cd('2') - c_a*Ca('2')) - c_qc*qc('2')) + lambda('2')*(q('2') - s('2')) + lambdac('2')*(qc('2') - sc('2'));
...
CostoIndividual3..  J3 =E= -(q('3')*(c_b*Cb('3') + c_c*Cc('3') + c_d*Cd('3') - c_a*Ca('3')) - c_qc*qc('3')) + lambda('3')*(q('3') - s('3')) + lambdac('3')*(qc('3') - sc('3'));
 
CostoTotal.. J_total =E= J1 + J2 + J3;
...
while (n_iter < 100,
    ...
    s('1') = s('1') - step_size*lambda.l('1');
    s('2') = s('2') - step_size*lambda.l('2');
    s('3') = s('3') - step_size*lambda.l('3');
    sc('1') = sc('1') - step_size*lambdac.l('1');
    sc('2') = sc('2') - step_size*lambdac.l('2');
    sc('3') = sc('3') - step_size*lambdac.l('3');

    put n_iter, q.l('1'), q.l('2'), q.l('3'), qc.l('1'), qc.l('2'), qc.l('3'), s('1'), s('2'), s('3'), sc('1'), sc('2'), sc('3')/;
*    put n_iter, q.l('1'), q.l('2'), q.l('3'), qc.l('1'), qc.l('2'), qc.l('3'), lambda.l('1'), lambda.l('2'), lambda.l('3'), lambdac.l('1'), lambdac.l('2'), lambdac.l('3')/;
*    reporte.ap = 1;
);
putclose;
