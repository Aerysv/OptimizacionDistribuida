...
*s_old1 = (sum(i, q.l(i)) - qmax);
*s_old2 = (sum(i, qc.l(i)) - qcmax);
...
*    s2 = (sum(i, qc.l(i)) - qcmax);
    ...
    s1 = (sum(i, q.l(i)) - qmax)/qmax;
    s2 = (sum(i, qc.l(i)) - qcmax)/qcmax;
    ...
    lambda_1 = max(0, lambda_1 + step_1*(beta*s1 + (1 - beta)*s_old1 )/sqr(norma2) );
    lambda_2 = max(0, lambda_2 + step_2*(beta*s2 + (1 - beta)*s_old2 )/sqr(norma2) );
...
* Convergencia
    ...
    put n_iter, q.l('1'), q.l('2'), q.l('3'), qc.l('1'), qc.l('2'), qc.l('3'), lambda_1, lambda_2, J_dual, norma2, step_1, step_2 /;
    );
